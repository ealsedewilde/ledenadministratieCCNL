...
The alternative is to produce a zip-file. That is what I've done via the maven-assembly-plugin. To get a nice launcher, I converted my startup bat file to an exe with a nice icon. I used BatTo EXE for this. (I'm quite happy with this deployment with a size of just over 100mb.)
