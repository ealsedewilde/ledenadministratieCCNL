...
public enum MenuChoice {
  ...
  NEW_INTERNAL_RELATION, AMEND_INTERNAL_RELATION(SEARCH_INTERNAL), DELETE_INTERNAL_RELATION(
      SEARCH_INTERNAL),
  //
  MAGAZINE_ADDRESS_LIST, CARD_ADDRESS_LIST, MEMBER_LIST_BY_NUMBER, MEMBER_LIST_BY_NAME, MAGAZINE_INVALID_ADDRESS(SEARCH_MEMBER),
  //
  ...
  //
  RESET_PAYMENTS(COMMANDS), ANNUAL_ROLLOVER, PRODUCE_DIRECT_DEBITS_FILE,
  //
  PRODUCE_REMINDER_REPORT(COMMANDS), PRODUCE_REMINDER_LETTERS_DD, PRODUCE_REMINDER_LETTERS_BT,
  //
  RECONCILE_PAYMENTS, HANDLE_OVERDUE,
  //
  MANAGE_SEPA_FORM(COMMANDS), TEMPLATES_OVERVIEW,

  MANAGE_BACKUP_DATABASE(COMMANDS), MANAGE_RESTORE_DATABASE,
