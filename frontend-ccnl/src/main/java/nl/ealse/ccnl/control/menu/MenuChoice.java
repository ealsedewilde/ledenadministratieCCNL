...
public enum MenuChoice {
  ...
  REPORT_ALL_DATA(REPORTS, true), REPORT_NEW_MEMBERS(REPORTS, true), REPORT_OVERDUE_MEMBERS(REPORTS,
      true), REPORT_CANCELLED_MEMBERS(REPORTS, true), REPORT_AFTER_APRIL(REPORTS, true), REPORT_ARCHIVE(REPORTS, true),
  //
  RESET_PAYMENTS(true), ANNUAL_ROLLOVER, PRODUCE_DIRECT_DEBITS_FILE,
  //
  PRODUCE_REMINDER_REPORT(true), PRODUCE_REMINDER_LETTERS_DD, PRODUCE_REMINDER_LETTERS_BT, PRODUCE_REMINDER_LETTERS_BT_X,
  //
